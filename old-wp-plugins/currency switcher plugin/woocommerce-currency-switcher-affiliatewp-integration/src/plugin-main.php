...
use Aelia\WC\CurrencySwitcher\AffiliateWP\Settings;
use Aelia\WC\CurrencySwitcher\AffiliateWP\Settings_Renderer;
use Aelia\WC\CurrencySwitcher\AffiliateWP\Messages;

/**
 * Main plugin class.
 **/
class Aelia_CS_AffiliateWP extends Aelia_Plugin {
	public static $version = '1.0.2.150525';

	public static $plugin_slug = Definitions::PLUGIN_SLUG;
	public static $text_domain = Definitions::TEXT_DOMAIN;
	public static $plugin_name = 'AffiliateWP integration for WooCommerce Currency Switcher';
	...
	public function plugins_loaded() {
		...
		// Initialise the integration with AffiliateWP
		AffiliateWP_Integration::instance();
	}
}

$GLOBALS[Aelia_CS_AffiliateWP::$plugin_slug] = Aelia_CS_AffiliateWP::factory();
