 ...
 */
class Aelia_CS_AffiliateWP_RequirementsChecks extends Aelia_WC_RequirementsChecks {
	// @var string The namespace for the messages displayed by the class.
	protected $text_domain = 'wc-aelia-cs-affiliatewp';
	// @var string The plugin for which the requirements are being checked. Change it in descendant classes.
	protected $plugin_name = 'WooCommerce Currency Switcher - AffiliateWP Integration';
	...
	protected $required_plugins = array(
		...
		'Aelia Currency Switcher for WooCommerce' => array(
			'version' => '3.6.33.150514',
			'extra_info' => 'You can buy the plugin <a href="http://aelia.co/shop/currency-switcher-woocommerce/">from our shop</a>.',
		),
		'AffiliateWP' => array(
			'version' => '1.6.2',
			'extra_info' => 'You can buy the plugin <a href="https://affiliatewp.com/">from the official AffiliateWP website</a>.',
		),
	);
